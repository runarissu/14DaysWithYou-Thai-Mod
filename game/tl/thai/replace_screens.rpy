...
init 5 python:
    ...
    renchatterlist_thai = [
        "วันนี้กินข้าวรึยัง?",
        f"{persistent.game_open} เป็นเลขโปรดใหม่ของฉันแล้ว!\nนี่คือจำนวนครั้งที่เปิดเกมนะ! >///<",
        "อย่าลืมกินน้ำนะ, Angel!",
        "คิดถึงจัง!",
        f"และแล้ว... ครั้งที่ {persistent.game_open}!\n ...อ๋อ? ก็ฉันนับว่าเปิดเกมกี่ครั้งไง!",
        "รักนะรักนะรักนะรักนะรักนะ!",
        "ที่รัก ตี 2 แล้วนะ ได้เวลาเล่น 14DWY แล้ว",
        "รักนะ, Angel!",
        "โอ? กลับมาเร็วจัง?",
        "กลุ้ปนึงเธอก็ยองกี้หมดแล้ว",
